...
1. 工具顶上选择临时数据保存目录 ./geoFix
2. 复制上一步csv中的一个问题polygon文本，粘贴到输入框
3. 点击“保存成json”按钮
4. 用gis软件人工修复此json：删除飞地直接Delete Part；补全缺口（非空洞）Add Polygon添加一个覆盖住的图形，然后选中两个合并到一起Merge Selected Features
...
移除 珠海香洲区 的一小块缺口，高德为 440499:澳门大学横琴校区(由澳门实施管辖)，未包含在内
440402 广东省 珠海市 香洲区

检查 安徽芜湖市 是否和下级边界 隔壁市边界不一致，2026-04-03数据库计算出不一致
3402 安徽省 芜湖市
	参考面 340210 安徽省 芜湖市 湾沚区
	参考面 3418 安徽省 宣城市
*/
(function(){
